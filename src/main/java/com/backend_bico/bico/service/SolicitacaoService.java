...
public class SolicitacaoService {
  ...
  public void solicitar(SolicitacaoDTO solicitacaoDTO) {
    ...
    Map<Usuario, Coordenadas> usuarios = new HashMap<>();
    ...
    Usuario usuarioProximo = getUsuarioMaisProximo(cordenadaRef, usuarios);

    Coordenadas coordenadasProximo = usuarios.get(usuarioProximo);
